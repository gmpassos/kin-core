...
public class KinClient {
    ...
    /**
     * For more details please look at {@link #KinClient(AppContext context, Environment environment, String appId, String storeKey)}
     */
    public KinClient(@NonNull AppContext context, @NonNull Environment environment, String appId) {
     ...
     */
    public KinClient(@NonNull AppContext context, @NonNull Environment environment, String appId, @NonNull AppInfoProvider appInfoProvider) {
        this(context, environment, appId, "");
     ...
     */
    public KinClient(@NonNull AppContext context, @NonNull Environment environment, @NonNull String appId, @NonNull String storeKey) {
     ...
     * @param appInfoProvider
     */
    public KinClient(@NonNull AppContext context, @NonNull Environment environment, @NonNull String appId, @NonNull String storeKey, @NonNull AppInfoProvider appInfoProvider) {
        delegate = new KinClientInternal(context, environment, appId, storeKey, appInfoProvider);
    }

    @VisibleForTesting
    public KinClient(AppContext context, Environment environment, String appId, String storeKey, BackupRestore backupRestore, KeyStore keyStore, Storage storage, KinEnvironment kinEnvironment) {
    ...
    @VisibleForTesting
    public KinClient(AppContext context, Environment environment, String appId, String storeKey, BackupRestore backupRestore, KeyStore keyStore, Storage storage) {
